...
public class TC_paymentAPI {
	...
	public void test_getAllPayments() {
		...
		.when()
			.get("http://localhost:8089/User/webapi/payments/")
	...
	public void test_getSpecificPayment() {
		...
		.when()
			.get("http://localhost:8089/User/webapi/payments/payment/1")
	...
	public void test_insertPayment() {
		...
		.when()
			.post("http://localhost:8089/User/webapi/payments/payment")
	...
	public void test_updatePayment() {
		...
		.when()
			.put("http://localhost:8089/User/webapi/payments/payment")
	...
	public void test_deletePayment() {
		...
		.when()
			.delete("http://localhost:8089/User/webapi/payments/payment/6")
